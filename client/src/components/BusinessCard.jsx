    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow overflow-hidden">
      ...
      <div className="p-4">
        ...
        <Link to={`/business/${slug}`}>
          <h3 className="text-lg font-bold text-gray-900 hover:text-red-600 transition-colors mb-2 line-clamp-2">
            {name}
          </h3>
        </Link>
        ...
        <div className="flex items-center mb-3">
          <div className="bg-red-600 text-white px-3 py-1 rounded-md font-bold text-lg">
        ...
        <div className="flex space-x-2">
          <Link
            to={`/business/${slug}`}
            className="flex-1 bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 transition-colors text-center text-sm font-semibold"
          >
            View Details
          </Link>
          {contact?.phone && (
